      ...
      <View style={styles.fixing}>
        ...
        <View style={styles.delivery}>
          ...
          <TouchableOpacity style={styles.deliveryBody} activeOpacity={0.7}>
            ...
            <View style={styles.deliveryPointBody}>
              ...
              <Text style={styles.deliveryPointDetail}>
        ...
        <View style={styles.pay}>
          ...
          <TouchableOpacity style={styles.payBody} activeOpacity={0.7}>
            <View style={styles.payLogo}>
              <Image
                source={{
                  uri: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Mastercard_2019_logo.svg/800px-Mastercard_2019_logo.svg.png",
                }}
                resizeMode="contain"
        ...
        <View style={styles.status}>
          ...
          <View style={styles.statusLineTotal}>
            ...
            <Text style={styles.statusValueTotal}>
              {sum} {CURRENCIES[0].symbol}
            </Text>
          </View>
        </View>
