import { View, StyleSheet, ScrollView, Text, TouchableOpacity, Vibration } from "react-native";
						...
						if (product) {
							return (
								<View key={product.id} style={styles.mainCon}>
									<CartItem product={product} count={count} editProductCount={editProductCount} removeItem={removeItem}  />
								</View>
							)
						}
					})}
