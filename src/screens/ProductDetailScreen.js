    ...
    <>
        ...
        <View style={styles.body}>
          <View style={styles.titleWrapper}>
            ...
            <TouchableOpacity
              ...
              onPress={() => toggleFavorites(product.id)}
            >
              {isExistsFavorite ? <Text>Иконка</Text> : <Text>Иконка</Text>}
            </TouchableOpacity>
          </View>
      ...
      <View style={styles.actions}>
        ...
        <TouchableOpacity
          style={[
            styles.toBasket,
            { backgroundColor: countInBasket ? "#12af00" : COLORS.mainRed },
          ]}
          onPress={() => basketHandler()}
        >
          {countInBasket ? (
            <>
              <Text style={styles.toBasketText}>
                В корзине {countInBasket} шт.
              </Text>
            </>
          ) : (
            <Text style={styles.toBasketText}>
              В корзину {count * product.price} {CURRENCIES[0].symbol}
            </Text>
          )}
        </TouchableOpacity>
      </View>
